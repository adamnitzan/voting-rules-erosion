...
def create_report_entries_for_specific_n_v_and_n_c(
    ...
    if rule1_mr_erosion is not None:
        assert rule2_mr_erosion is not None
        if (
...
def create_erosion_stats_reports_for_two_rules(
    *,
    ...
    if not parameter_pairs_for_rule1:
        print("No results found for this configuration. Aborting")
        exit(0)
    ...
    for param_pair in parameter_pairs_for_rule1:
        ...
        rule1_vs_MR_erosion_stats = rule2_vs_MR_erosion_stats = None
        ...
        if all_rules[rule1_name].is_point_rule and all_rules[rule2_name].is_point_rule:
            ...
            rule1_vs_MR_erosion_stats = create_two_rules_basic_erosion_stats(
                rule1_chosen=rule1_vs_mr_chosen,
                rule2_chosen=MR_vs_rule1_chosen,
                rule1_erosion=rule1_vs_MR_erosion,
                rule2_erosion=MR_vs_rule1_erosion,
                analytical_results_profile_weights=analytical_results_profile_weights,
                num_simulations=num_simulations,
                debug_data=debug_data,
            )
            ...
            rule2_vs_MR_erosion_stats = create_two_rules_basic_erosion_stats(
                rule1_chosen=rule2_vs_mr_chosen,
                rule2_chosen=MR_vs_rule2_chosen,
                rule1_erosion=rule2_vs_MR_erosion,
                rule2_erosion=MR_vs_rule2_erosion,
                analytical_results_profile_weights=analytical_results_profile_weights,
                num_simulations=num_simulations,
                debug_data=debug_data,
            )
