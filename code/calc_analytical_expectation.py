...
def calc_analytical_expectation(output_dir: str):
    """
    ...
    """
    num_voters = [3, 5, 7, 9, 11, 13, 15, 21, 31, 41, 51]
    num_choices = [3]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--output_dir",
        type=str,
        default="/home/hi-auto/Pictures/social_choice_cubic_analytical_results1",
    )
    args = parser.parse_args()
    calc_analytical_expectation(args.output_dir)
